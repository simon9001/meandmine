...
export async function updateSupplier(c) {
    const body = z.object({
...
export async function listProductSupply(c) {
    return ok(c, await svc.listProductSupply(c.req.param('productId')));
}
export async function upsertProductSupply(c) {
    const body = z.object({
...
export async function getPricingHistory(c) {
