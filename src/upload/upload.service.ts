...
export async function uploadProductImage(file: File, productId: string) {
  if (file.size > MAX_FILE_SIZE) throw new BadRequestError('Image must be under 10MB');
  if (!file.type.startsWith('image/')) throw new BadRequestError('File must be an image');
...
export async function uploadReviewImage(file: File, reviewId: string) {
  if (file.size > MAX_FILE_SIZE) throw new BadRequestError('Image must be under 10MB');
  if (!file.type.startsWith('image/')) throw new BadRequestError('File must be an image');
...
export async function uploadProductMediaImage(file: File) {
  if (file.size > MAX_FILE_SIZE) throw new BadRequestError('Image must be under 10MB');
  if (!file.type.startsWith('image/')) throw new BadRequestError('File must be an image');
